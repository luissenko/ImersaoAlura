...
var cartaMaquina;
var cartaJogador;
var cartas = [cartaPaulo, cartaRafa, cartaGui, cartaNaruto, cartaHarry, cartaMarvel];
...
function jogar() {
  ...
  if (cartas.length == 0){
    ...
    if (pontosJogador > pontosMaquina) {
      ...
      htmlResultado = '<p class="resultado-final">Houve um empate! Acredite se quiser!!!</p>'
    }
  } else {
...
function proximaRodada() {
  ...
  divCartas.innerHTML = `<div id="carta-jogador" class="carta"></div> <div id="carta-maquina" class=""></div>`
